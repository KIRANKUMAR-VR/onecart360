...
export function PantryList({ items, onIncrease, onDecrease, onDelete, onEdit, onUpdateQuantity, onToggleStock, readOnly = false, showStockToggle = false, showEditButton = false }: PantryListProps) {
  if (items.length === 0) {
    return (
      <Empty>
        <EmptyHeader>
