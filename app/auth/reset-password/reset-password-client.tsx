...
function ResetPasswordInner() {
  ...
  useEffect(() => {
    ...
    // ── token_hash path (OTP token from Supabase) ──────────────────────────
    // token_hash is an OTP token generated by Supabase for recovery.
    // Use verifyOtp to exchange it client-side (avoids email scanner issues).
    if (tokenHash) {
